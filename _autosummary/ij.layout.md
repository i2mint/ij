...
| [`force_directed`](ij.layout.force_directed.md#module-ij.layout.force_directed)   | Force-directed graph layout algorithm.         |
|---------------------------------------------------------------------------------------------------|------------------------------------------------|
| [`hierarchical`](ij.layout.hierarchical.md#module-ij.layout.hierarchical)       | Hierarchical (layered) graph layout algorithm. |
| [`layout_engine`](ij.layout.layout_engine.md#module-ij.layout.layout_engine)     | Layout engine for positioning diagram nodes.   |
