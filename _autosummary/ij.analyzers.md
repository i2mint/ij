...
| [`python_analyzer`](ij.analyzers.python_analyzer.md#module-ij.analyzers.python_analyzer)   | Python code analyzer for reverse engineering diagrams.   |
|--------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| [`typescript`](ij.analyzers.typescript.md#module-ij.analyzers.typescript)             | TypeScript and JavaScript code analyzer.                 |
