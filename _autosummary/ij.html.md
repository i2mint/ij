...
* **Parameters:**
  * **diagram1** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – Original diagram
  * **diagram2** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – Modified diagram
* **Return type:**
  [`DiagramChanges`](ij.git_integration.html.md#ij.git_integration.DiagramChanges)
* **Returns:**
...
* **Parameters:**
  **changes** ([`DiagramChanges`](ij.git_integration.html.md#ij.git_integration.DiagramChanges)) – DiagramChanges to report
* **Return type:**
  [`str`](https://docs.python.org/3/builtins/stdtypes.html#str)
* **Returns:**
...
* **Parameters:**
  * **base** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – Common ancestor diagram
  * **branch1** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – First modified version
  * **branch2** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – Second modified version
...
* **Parameters:**
  ...
  * **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR snapshot
...
* **Return type:**
  [`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)]
* **Returns:**
...
* **Return type:**
  [`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`Node`](ij.core.html.md#ij.core.Node)]
...
* **Parameters:**
  **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR to lint
* **Return type:**
  [`List`](https://docs.python.org/3/library/typing.html#typing.List)[[`ValidationIssue`](ij.validation.html.md#ij.validation.ValidationIssue)]
* **Returns:**
...
* **Parameters:**
  * **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR to validate
...
* **Return type:**
  [`ValidationResult`](ij.validation.html.md#ij.validation.ValidationResult)
* **Returns:**
...
* **Parameters:**
  **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR to convert
* **Return type:**
  `DiGraph`
* **Returns:**
  NetworkX DiGraph
...
* **Parameters:**
  **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR to sort
* **Return type:**
...
* **Parameters:**
  ...
  * **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR to process
...
* **Parameters:**
  **plugin** ([`Plugin`](ij.plugins.plugin_manager.html.md#ij.plugins.plugin_manager.Plugin)) – Plugin instance to register
...
#### *property* errors *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[ValidationIssue](ij.validation.html.md#ij.validation.ValidationIssue)]*

Get only error-level issues.

#### *property* warnings *: [List](https://docs.python.org/3/library/typing.html#typing.List)[[ValidationIssue](ij.validation.html.md#ij.validation.ValidationIssue)]*
...
* **Parameters:**
  * **diagram** ([`DiagramIR`](ij.core.html.md#ij.core.DiagramIR)) – DiagramIR to export
  * **output_path** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – Output file path
...
| [`importers`](ij.importers.html.md#module-ij.importers)             | Import diagrams from external sources.                     |
|--------------------------------------------------------------------------------------------|------------------------------------------------------------|
| [`analyzers`](ij.analyzers.html.md#module-ij.analyzers)             | Code analyzers for reverse engineering diagrams from code. |
| [`cli`](ij.cli.html.md#module-ij.cli)                         | Command-line interface for Idea Junction.                  |
| [`cli_enhanced`](ij.cli_enhanced.html.md#module-ij.cli_enhanced)       | Enhanced command-line interface for Idea Junction.         |
| [`converters`](ij.converters.html.md#module-ij.converters)           | Converters between different representations.              |
| [`core`](ij.core.html.md#module-ij.core)                       | Core data structures for Idea Junction.                    |
| [`diagrams`](ij.diagrams.html.md#module-ij.diagrams)               | Advanced diagram types.                                    |
| [`export`](ij.export.html.md#module-ij.export)                   | Export functionality.                                      |
| [`git_integration`](ij.git_integration.html.md#module-ij.git_integration) | Git integration for diagram version control and diffing.   |
| [`graph_ops`](ij.graph_ops.html.md#module-ij.graph_ops)             | Graph operations using NetworkX.                           |
| [`layout`](ij.layout.html.md#module-ij.layout)                   | Layout algorithms for diagram positioning.                 |
| [`parsers`](ij.parsers.html.md#module-ij.parsers)                 | Diagram parsers for various formats.                       |
| [`plugins`](ij.plugins.html.md#module-ij.plugins)                 | Plugin system for extensibility.                           |
| [`renderers`](ij.renderers.html.md#module-ij.renderers)             | Diagram renderers for various formats.                     |
| [`transforms`](ij.transforms.html.md#module-ij.transforms)           | Diagram transformation and optimization utilities.         |
| [`validation`](ij.validation.html.md#module-ij.validation)           | Diagram validation and linting.                            |
| [`viewer`](ij.viewer.html.md#module-ij.viewer)                   | Interactive web viewer for diagrams.                       |
