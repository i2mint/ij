...
| [`d2`](ij.renderers.d2.md#module-ij.renderers.d2)             | D2 diagram renderer.                          |
|----------------------------------------------------------------------------------------|-----------------------------------------------|
| [`graphviz`](ij.renderers.graphviz.md#module-ij.renderers.graphviz) | Graphviz/DOT diagram renderer.                |
| [`mermaid`](ij.renderers.mermaid.md#module-ij.renderers.mermaid)   | Mermaid diagram renderer.                     |
| [`plantuml`](ij.renderers.plantuml.md#module-ij.renderers.plantuml) | PlantUML diagram renderer.                    |
| [`sequence`](ij.renderers.sequence.md#module-ij.renderers.sequence) | Sequence diagram renderer for Mermaid format. |
