...
| [`erd`](ij.diagrams.erd.md#module-ij.diagrams.erd)                     | Entity-Relationship Diagram support.   |
|-------------------------------------------------------------------------------------------------|----------------------------------------|
| [`state_machine`](ij.diagrams.state_machine.md#module-ij.diagrams.state_machine) | State Machine diagram support.         |
