...
* **Return type:**
  [`ERDiagram`](ij.diagrams.erd.md#ij.diagrams.erd.ERDiagram)
* **Returns:**
...
| [`database`](ij.importers.database.md#module-ij.importers.database)   | Import diagrams from database schemas.       |
|------------------------------------------------------------------------------------------|----------------------------------------------|
| [`drawio`](ij.importers.drawio.md#module-ij.importers.drawio)       | Import diagrams from draw.io files.          |
| [`openapi`](ij.importers.openapi.md#module-ij.importers.openapi)     | Import diagrams from OpenAPI specifications. |
| [`plantuml`](ij.importers.plantuml.md#module-ij.importers.plantuml)   | Import diagrams from PlantUML format.        |
